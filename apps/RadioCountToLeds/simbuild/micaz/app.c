...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x40396a98, const void *arg_0x40396c30);
#line 776
__extension__ 
#line 793
__extension__ 
...
#line 252
extern double erfc(double arg_0x403e5da8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
...
unsigned int (*hashfunction)(void *arg_0x40541320), 
int (*key_eq_fn)(void *arg_0x40541768, void *arg_0x405418e0));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x40675558, int arg_0x406756b0);
static double RandomUniform(void );
...
# 61 "/home/user/top/t2_cur/tinyos-2.x/tos/interfaces/Leds.nc"
...
#line 40
# 79 "/home/user/top/t2_cur/tinyos-2.x/tos/system/LedsP.nc"
static inline void LedsP$Leds$led0Off(void )
#line 79
{
  LedsP$Led0$set();
...
#line 115
{
  sim_log_debug(151U, "RadioCountToLedsC", "Received packet of length %hhu.\n", len);
...
# 78 "/home/user/top/t2_cur/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x408cdb08, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x408cdb08) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x408cdb08, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/user/top/t2_cur/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x408ca1b8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x408ca1b8, msg, payload, len);
#line 78
...
# 110 "/home/user/top/t2_cur/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x408cd148, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x408cd148, msg, error);
#line 110
}
#line 110
...
# 100 "/home/user/top/t2_cur/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40a3b010, message_t * msg, error_t error){
#line 100
  switch (arg_0x40a3b010) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40a3b010, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/user/top/t2_cur/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x407123c0){
#line 75
  switch (arg_0x407123c0) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x407123c0);
#line 75
      break;
#line 75
    }
...
#line 53
# 80 "/home/user/top/t2_cur/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40a599a8, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  enum __nesc_unnamed4279 __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40a599a8, addr, msg, len);
#line 80
...
#line 75
# 170 "/home/user/top/t2_cur/tinyos-2.x/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void TossimActiveMessageC$AMPacket$setType(message_t *amsg, am_id_t t)
#line 170
{
...
#line 94
{
  ...
  sim_log_debug(149U, "RadioCountToLedsC", "RadioCountToLedsC: timer fired, counter is %hu.\n", RadioCountToLedsC$counter[sim_node()]);
...
#line 102
      ...
      if (RadioCountToLedsC$AMSend$send(AM_BROADCAST_ADDR, &RadioCountToLedsC$packet[sim_node()], sizeof(radio_count_msg_t )) == SUCCESS) {
          sim_log_debug(150U, "RadioCountToLedsC", "RadioCountToLedsC: packet sent.\n", RadioCountToLedsC$counter[sim_node()]);
...
# 83 "/home/user/top/t2_cur/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40bc23a8){
#line 83
  switch (arg_0x40bc23a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40bc23a8);
#line 83
      break;
#line 83
    }
...
# 177 "/home/user/top/t2_cur/tinyos-2.x/tos/lib/tossim/TossimActiveMessageC.nc"
static inline uint8_t TossimActiveMessageC$Packet$payloadLength(message_t *msg)
#line 177
{
